...
$("#cari_tanggal").on("click",function(){
    ...
    $.get("<?php echo base_url()?>index.php/laporan_keuangan_gudang/by_tgl/"+tgl,function(e){
      console.log("<?php echo base_url()?>index.php/laporan_keuangan_gudang/by_tgl/"+tgl);
      $.each(e,function(a,b){
...
$("#trx_lama").on("change",function(){
  ...
  $("#form_penarikan_kas").on("submit",function(){
    ...
    {
      $.post("<?php echo base_url()?>index.php/laporan_keuangan_gudang/go_koreksi",$(this).serialize(),function(x){
