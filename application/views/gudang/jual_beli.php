...
$("#go_trx_jurnal").on("submit",function(){
    ...
    eksekusi_controller('<?php echo base_url()?>index.php/gudang/laporan_jual_beli/?tgl_awal='+tgl_awal+'&tgl_akhir='+tgl_akhir,'Laporan Penjualan Pembelian');
  return false;
})
...
$("#download_pdf").on("click",function(){
  var tgl_awal   = $("#tgl_awal").val();
  var tgl_akhir  = $("#tgl_akhir").val();  
  var url='<?php echo base_url()?>index.php/gudang/laporan_jual_beli_xl/?tgl_awal='+tgl_awal+'&tgl_akhir='+tgl_akhir;
  window.open(url);
