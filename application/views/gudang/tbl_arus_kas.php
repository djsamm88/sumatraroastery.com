...
$('.datepicker').datepicker({
  ...
  $("#tbl_arus_kas").on("click","tbody tr td #detail",function(){
    ...
    $.get("<?php echo base_url()?>index.php/laporan_keuangan_gudang/detail_arus_kas",ser,function(a){
      $("#t4_detail").html(a);
...
$("#go_trx_kas").on("submit",function(){
  $.get("<?php echo base_url()?>index.php/laporan_keuangan_gudang/detail_arus_kas",$(this).serialize(),function(a){
      $("#t4_detail").html(a);
    })
...
$("#download_pdf").on("click",function(){
  var ser = $("#go_trx_kas").serialize();
  var url="<?php echo base_url()?>index.php/laporan_keuangan_gudang/detail_arus_kas_pdf/?"+ser;
  window.open(url);
