...
$("#go_trx_jurnal").on("submit",function(){
    ...
    eksekusi_controller('<?php echo base_url()?>index.php/laporan_keuangan_gudang/laporan_jurnal/?tgl_awal='+tgl_awal+'&tgl_akhir='+tgl_akhir,'Laporan Jurnal');
  return false;
})
...
$("#download_pdf").on("click",function(){
  ...
  var url="<?php echo base_url()?>index.php/laporan_keuangan_gudang/laporan_jurnal_pdf/?"+ser;
  window.open(url);
