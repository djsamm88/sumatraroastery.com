...
if (!defined('BASEPATH'))exit('No direct script access allowed');
	...
	class M_laporan_keuangan_gudang extends CI_Model {
							...
							SELECT a.*,
								...
								(
									...
									(
										...
										FROM 
										(
										SELECT a.*,(a.tgl_update) AS tanggal,b.nama,b.jenis FROM `tbl_transaksi_gudang` a 
										INNER JOIN tbl_group_transaksi_gudang b 
										ON a.id_group=b.id
										)a
									)a 
								)a
	...
	public function m_sisa_kas()
	{
		$q = $this->db->query("
								...
								FROM ( 
									...
									FROM `tbl_transaksi_gudang` a 
									LEFT JOIN tbl_group_transaksi_gudang b 
									ON a.id_group=b.id 
									)a 
							...
							SELECT a.nama,a.id_group,a.urutan,
								...
								(								    
									SELECT a.nama,a.id AS id_group,a.urutan,
										...
										FROM tbl_group_transaksi_gudang a 
										LEFT JOIN 
										(
											SELECT id_group,SUM(jumlah) AS jumlah FROM `tbl_transaksi_gudang`
							...
							SELECT a.*,
								...
								(
									...
									(
										...
										FROM 
										(
										SELECT a.*,DATE(a.tgl_update) AS tanggal,b.nama,b.jenis FROM `tbl_transaksi_gudang` a 
										INNER JOIN tbl_group_transaksi_gudang b 
										ON a.id_group=b.id
										)a
										WHERE (a.jumlah*1)<>0
							...
							INNER JOIN(
							    ...
							    FROM
							        ...
							        SELECT
							            ...
							            b.jenis
							        FROM
							            `tbl_transaksi_gudang` a
							        INNER JOIN tbl_group_transaksi_gudang b ON
							            a.id_group = b.id
							        WHERE
							            (
